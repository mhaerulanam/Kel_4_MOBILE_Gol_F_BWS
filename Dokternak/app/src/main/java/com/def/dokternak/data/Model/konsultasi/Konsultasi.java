...
public class Konsultasi {
    ...
    public Konsultasi(int id_konsultasi, int id_peternak, int id_dokter, int id_katgeori, int id_ktg, int id_jabatn, int id, String namaHewan, String keluhan, String tanggal, String statusKirim, String namaDokter, String email, String jenisKelamin, String alamat, String tempat, String telpon, String foto, String sertifikasi, String jadwalKerja, String verifikasi, String namaDepanPeternak, String namaBelakangPeternak, String emailPeternak, String noHpPeternak, String fotoPeternak, String jenisHewan, String kategoriHewan) {
