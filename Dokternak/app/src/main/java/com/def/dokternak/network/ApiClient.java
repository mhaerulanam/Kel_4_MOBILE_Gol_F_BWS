...
public class ApiClient {
    ...
    //URI Hosting Dokternak.id
    public static final String BASE_URL = "https://www.dokternak.id/api/";
    public static final String ARTIKEL_IMAGE_BASE_URL = "https://www.dokternak.id/public/data/data_artikel/";
    public static final String PETUGAS_IMAGE_BASE_URL = "https://www.dokternak.id/public/data/data_dokter/";
    public static final String PETERNAK_IMAGE_BASE_URL = "https://www.dokternak.id/public/data/data_peternak/";
    public static final String PUSKESWAN_IMAGE_BASE_URL = "https://www.dokternak.id/public/data/data_puskeswan/";
