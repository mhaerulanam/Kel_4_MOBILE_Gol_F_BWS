...
public class GetPuskeswan {
    ...
    public GetPuskeswan(String status, List<Puskeswan> listDataPuskeswan, String message) {
        this.status = status;
    ...
    public List<Puskeswan> getListDataPuskeswan() { return listDataPuskeswan;  }
