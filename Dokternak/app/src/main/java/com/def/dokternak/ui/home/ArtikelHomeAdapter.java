...
import com.def.dokternak.ui.artikel.DetailArtikelActivity;

import java.util.List;

import static com.def.dokternak.network.ApiClient.ARTIKEL_IMAGE_BASE_URL;

public class ArtikelHomeAdapter extends RecyclerView.Adapter<ArtikelHomeAdapter.MyViewHolder> {
    List<Artikel> mArtikelList;

    public ArtikelHomeAdapter(List <Artikel> artikelList) {
